  ...
  return (
    <div className="page-stack page-stack--flush relative">
      <div className="pointer-events-none absolute inset-y-0 left-1/2 -z-10 w-screen -translate-x-1/2">
        <div className="absolute left-1/2 top-[24rem] h-[58rem] w-[132rem] -translate-x-1/2 blur-[220px] bg-[radial-gradient(circle_at_18%_30%,rgba(160,132,222,0.18),transparent_26%),radial-gradient(circle_at_52%_48%,rgba(131,96,188,0.16),transparent_30%),radial-gradient(circle_at_82%_34%,rgba(214,136,190,0.12),transparent_24%)] dark:bg-[radial-gradient(circle_at_18%_30%,rgba(132,96,216,0.14),transparent_26%),radial-gradient(circle_at_52%_48%,rgba(102,72,164,0.16),transparent_30%),radial-gradient(circle_at_82%_34%,rgba(178,88,150,0.08),transparent_24%)]" />

        <div className="absolute left-1/2 top-[78rem] h-[64rem] w-[138rem] -translate-x-1/2 blur-[250px] bg-[radial-gradient(circle_at_76%_36%,rgba(148,112,210,0.17),transparent_24%),radial-gradient(circle_at_28%_44%,rgba(98,76,170,0.16),transparent_32%),radial-gradient(circle_at_60%_78%,rgba(221,146,192,0.1),transparent_26%)] dark:bg-[radial-gradient(circle_at_76%_36%,rgba(124,88,194,0.14),transparent_24%),radial-gradient(circle_at_28%_44%,rgba(80,62,148,0.16),transparent_32%),radial-gradient(circle_at_60%_78%,rgba(184,88,144,0.07),transparent_26%)]" />

        <div className="absolute left-1/2 top-[126rem] h-[56rem] w-[128rem] -translate-x-1/2 blur-[235px] bg-[radial-gradient(circle_at_22%_44%,rgba(145,114,206,0.16),transparent_24%),radial-gradient(circle_at_72%_34%,rgba(104,82,176,0.14),transparent_30%),radial-gradient(circle_at_54%_74%,rgba(212,150,198,0.08),transparent_24%)] dark:bg-[radial-gradient(circle_at_22%_44%,rgba(118,88,188,0.13),transparent_24%),radial-gradient(circle_at_72%_34%,rgba(82,66,152,0.14),transparent_30%),radial-gradient(circle_at_54%_74%,rgba(172,98,152,0.06),transparent_24%)]" />

        <div className="absolute left-1/2 top-[172rem] h-[46rem] w-[118rem] -translate-x-1/2 blur-[220px] bg-[radial-gradient(circle_at_68%_42%,rgba(156,124,218,0.14),transparent_28%),radial-gradient(circle_at_34%_56%,rgba(120,88,180,0.12),transparent_30%),radial-gradient(circle_at_52%_72%,rgba(226,180,180,0.06),transparent_26%)] dark:bg-[radial-gradient(circle_at_68%_42%,rgba(122,92,198,0.12),transparent_28%),radial-gradient(circle_at_34%_56%,rgba(94,70,156,0.12),transparent_30%),radial-gradient(circle_at_52%_72%,rgba(180,110,132,0.05),transparent_26%)]" />
      </div>
      <ScrollReveal>
